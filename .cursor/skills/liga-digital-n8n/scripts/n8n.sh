#!/usr/bin/env bash
#
# n8n.sh — authenticated client for the Liga Digital n8n Public REST API (/api/v1).
#
# Usage:
...
#   LIGA_DIGITAL_N8N_URL      Base URL   (default: https://n8n-editor.iali.io)
#   LIGA_DIGITAL_N8N_API_KEY  n8n public API key (sent as X-N8N-API-KEY) — REQUIRED
#
# You can export these in your shell, or drop them in an untracked
# ".cursor/skills/liga-digital-n8n/.env" file (gitignored) which this script auto-loads.
#
# Notes:
...
BASE_URL="${LIGA_DIGITAL_N8N_URL:-https://n8n-editor.iali.io}"
API_KEY="${LIGA_DIGITAL_N8N_API_KEY:?LIGA_DIGITAL_N8N_API_KEY is not set. Export it or add it to .cursor/skills/liga-digital-n8n/.env (see SKILL.md).}"
